<template>
    ...
    <div class="layout-padding">
      ...
      <div class="layout-padding" style="font-weight:bold">
        <p> Pear built the Pear app as a Free app. This SERVICE is provided by Pear at no cost and is intended for use as is.
        </p>
        ...
        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Pear unless otherwise defined in this Privacy Policy.</p>

        <p class="subtitle"><strong>Information Collection and Use</strong></p> <p>For a better experience, while using our Service, We may require you to provide us with certain personally identifiable information, including but not limited to Facebook App Id, Uploaded photos. The information that We request is retained on your device and is not collected by us in any way</p>
